...
public class Game {
    ...
    public Game()
    {
        ...
        handlers.put("hi", new HandlerMap(this));
        createRooms();
    }
    ...
    private void createRooms() {
        ...
        pub = new Room("天使的馈赠");
        florist = new Room("花店", "芙罗拉<花语店主>");
        memorialStore = new Room("荣光之风", "玛乔丽<荣光之风店主>");
        store = new Room("百货商店", "布兰琪<蒙德百货售货员>");
        syntheticPlatform = new Room("炼金", "提玛乌斯<炼金学者>");
        fish = new Room("蒙德钓鱼协会","楠塔克<蒙德渔师>");
    ...
    private void printWelcome() {
        ...
        showComputer();
        System.out.println("支持的指令有：go hi map help quit");
    ...
    public void showSpeak() {
        System.out.println(currentNpc.getExitDesc());
        System.out.println();
    }
